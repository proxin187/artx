 ...
 */
static char *font = "Iosevka Nerd Font Mono:size=12:style=Regular";
#if FONT2_PATCH
/* Spare fonts */
static char *font2[] = {
...
static const char *colorname[] = {
    ...
    "#cf87e8", /* 5 magenta */
    "#79dac8", /* 6 cyan */
    "#bdbdbd", /* 7 gray (foreground, slightly darker than bright white for normal) */

    /* 8 bright colors */
    "#949494", /* 8 bright black */
    "#ff5189", /* 9 bright red */
    "#36c692", /* 10 bright green */
    "#c6c684", /* 11 bright yellow */
    "#74b2ff", /* 12 bright blue */
    "#ae81ff", /* 13 bright magenta */
    "#85dc85", /* 14 bright cyan */
    "#e4e4e4", /* 15 bright white */

    [255] = 0,

    "#9e9e9e", /* 256 -> cursor (from cursor in the provided scheme) */
    "#323437", /* 257 -> rev cursor (a mid-gray to contrast on light text) */
    "#080808", /* 258 -> bg (true black background) */
    "#bdbdbd", /* 259 -> fg (main foreground) */
};
